...
uint16_t rxSize = 6;
bool isSixBytes = true; // true��ʾ��ض���Ϊ���ط��͵�6���ֽڣ�false��ʾ��ض���HCB��ظ���4���ֽ�
...
void ProcessElevatorData(void)
{
    ...
    if (isFixBytes && rx_data_Elevator[0] == rxDataEleHeander)
    {
        ...
        if (checkXor == rx_data_Elevator[4])
        {
            ...
            masterElevator_LevelingSignal = (rx_data_Elevator[1] >> 0) & 0x01; // ƽ���ź�
            ...
            */
            ...
            // ����2��λ�����
            ByteBits *byte_bits = (ByteBits *)&tx_data_Door[1]; // ָ�� packet[1]
