...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PB8     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = DTS6012_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART3;
    HAL_GPIO_Init(DTS6012_TX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DTS6012_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF13_USART3;
    HAL_GPIO_Init(DTS6012_RX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB8     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, DTS6012_TX_Pin|DTS6012_RX_Pin);
...
{
	HAL_GPIO_WritePin(RS485_GHP_EN_GPIO_Port,RS485_GHP_EN_Pin,1); //ʹ��485����	
